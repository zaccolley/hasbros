...
var exists = localStorage.getItem("first_name"); if (reset==1)  exists=null;
if (exists == null)  localStorage.setItem("first_name", "h4x0r");

exists = localStorage.getItem("first_score");  if (reset==1)  exists=null;
if (exists == null)    localStorage.setItem("first_score", 501);


exists = localStorage.getItem("second_name"); if (reset==1)  exists=null;
if (exists == null)  localStorage.setItem("second_name", "pro");

exists = localStorage.getItem("second_score"); if (reset==1)  exists=null;
if (exists == null)    localStorage.setItem("second_score", 401);

exists = localStorage.getItem("third_name"); if (reset==1)  exists=null;
if (exists == null)  localStorage.setItem("third_name", "fluffy_cat");

exists = localStorage.getItem("third_score"); if (reset==1)  exists=null;
if (exists == null)    localStorage.setItem("third_score", 266);

exists = localStorage.getItem("fourth_name"); if (reset==1)  exists=null;
if (exists == null)  localStorage.setItem("fourth_name", "n00b");

exists = localStorage.getItem("fourth_score"); if (reset==1)  exists=null;
if (exists == null)    localStorage.setItem("fourth_score", -50);

exists = localStorage.getItem("fifth_name"); if (reset==1)  exists=null;
if (exists == null)  localStorage.setItem("fifth_name", "derp");

exists = localStorage.getItem("fifth_score"); if (reset==1)  exists=null;
